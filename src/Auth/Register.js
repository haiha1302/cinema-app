...
const Register = () => {
    return (
        <>
            <Meta title='Register your account' description='Register account' />
            <FormLoginStyle>
                ...
                <div>
                    If you already have an account. <Link to='/register'>Login here</Link>
                </div>
                <div className='mt-4'>
                    <div 
                    ...
                    <div className='btn-login-social btnGg'>
                        <BsGoogle />
                        Login with Google
                    </div>
                    ...
                    <div className='btn-login-social btnGh'>
                        <BsGithub />
                        Login with Github
                    </div>
                </div>
